...
interface CafeRestoReservationFormProps {
  activityId: number;
  userId: string;
  onSuccess: () => void;
}

const CafeRestoReservationForm: React.FC<CafeRestoReservationFormProps> = ({ 
  activityId, 
  userId, 
  onSuccess 
}) => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Réservation Restaurant</Text>
...
export default CafeRestoReservationForm;