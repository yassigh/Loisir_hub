...
import { getSubscriptionPlanById, updateSubscriptionPlan } from '../../../services/subscriptionPlanService';

function EditSubscriptionPlanAd() {
  ...
  return (
    <div style={{ marginLeft: '10px' }}>
      <div className="app-hero-header d-flex justify-content-between align-items-center">
        <div>
          <h1 className="fs-5 mb-0">Edit Subscription Plan</h1>
          <p className="mb-0">Update subscription plan details</p>
        </div>
      </div>
      ...
      <div className="card">
        <div className="card-body">
          <form onSubmit={handleSubmit}>
            {/* Same form fields as AddSubscriptionPlanAd */}
            <div className="mb-3">
...
export default EditSubscriptionPlanAd;